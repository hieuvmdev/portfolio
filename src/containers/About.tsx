    ...
    <Wrapper id="about" {...getSectionAnimation}>
      ...
      <main className="flex flex-col items-center gap-16 lg:items-start lg:flex-row">
        <div className="space-y-4 lg:w-3/5">
          <p>
            Hi, my name is Hieu Vu,  a Senior Unity Developer with 8+ year of
            ...
            .<br /> I can work on both front-end and back-end development, VR and blockchain intergration . I can fast learning new technology and new programming language.
          </p>
          <p>
            Fast-forward to today, and I've had the privilege of working at {' '}
            <Link
              href="https://curlyblue.com/"
              target="_blank"
